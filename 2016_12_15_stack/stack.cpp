...
{
	Node* p=head;
	if(p!=NULL){//=================   本来是 p,改成p->next 还是不行  2016-12-1
...
int main(){//对栈的操作验证
	...
	for(int j=1;j<8;j++){//j 不能大于 8，大于之后就运行错误，肯定是deleteFromtail
